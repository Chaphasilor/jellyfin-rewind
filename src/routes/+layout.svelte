...
<Modal open={$isAccuracyDisclaimerOpen}>
  <div class="flex flex-col items-center gap-2 z-20">
    ...
    <p>
      ...
      reporting the current playback states, and currently most music players
      that are compatible with Jellyfin seem to struggle with this in one way or
      another.
      <span class="font-semibold"
    ...
    <p>
      ...
      than 2 minutes, so why not do it right now? Your Jellyfin Rewind isn't
      going anywhere!
    </p>
    ...
    <p>
      ...
      year's Jellyfin Rewind, so that more information can be used and the used
      data can be properly limited to the current year only. Because of this,
      please <span class="font-semibold"
