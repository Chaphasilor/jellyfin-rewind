...
export class Track {
  constructor({ name, id, artistsBaseInfo, albumBaseInfo, genreBaseInfo, image, year, duration, skips, playCount, plays, mostSuccessivePlays, lastPlayed, totalPlayDuration, isFavorite }) {
    this.name = name
    this.id = id
